...
Custom commands are in addition to the built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/share-local`, `/help`. [Learn more](/docs/tui#commands).
...
opencode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/share-local`, `/help`; [learn more](/docs/tui#commands).
...
For programmatic access to sharing functionality, see the [CLI documentation](/docs/cli#share-local) for the `share-local` command.
