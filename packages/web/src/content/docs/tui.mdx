...
Share current session locally as an HTML file.

```bash frame="none"
/share-local
```

Generates an HTML file in your project's `.opencode/shares/` directory containing the conversation that can be opened in any web browser.
